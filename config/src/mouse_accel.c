...
static void adjust_mouse_speed(struct zmk_sensor_input_event *ev) {
    ...
    float mul = 0.5f;
    if      (size > 300) mul = 0.00000006f;
    else if (size > 150) mul = 0.00000005f;
    else if (size >  75) mul = 0.00000004f;
    else if (size >  30) mul = 0.00000003f;
    else if (size >  15) mul = 0.00000002f;
    else if (size >  8) mul = 0.00000001;
