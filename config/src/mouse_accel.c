...
static void adjust_mouse_speed(struct zmk_sensor_input_event *ev) {
    ...
    float mul = 0.6f;
    if      (size > 100) mul = 0.0006f;
    else if (size > 30) mul = 0.0005f;
    else if (size >  5) mul = 0.0004f;
    else if (size >  3) mul = 0.0003f;
    else if (size >  2) mul = 0.0002f;
    else if (size >  1) mul = 0.0001;
